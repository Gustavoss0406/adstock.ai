...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const redirectPath = returnTo === "/onboarding" ? `/onboarding?connected=linkedin` : `/workspace/${orgId}?connected=linkedin`
    ...
    if (!tokenRes.ok) {
      ...
      return NextResponse.redirect(`${baseUrl}/?error=linkedin_token_failed`)
    }
    ...
    return NextResponse.redirect(`${baseUrl}/?error=linkedin_callback_failed`)
  }
}
